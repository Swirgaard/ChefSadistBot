...
start_text = (
        ...
        "Кстати, если хочешь погрузиться глубже в философию кулинарного доминирования и не пропустить новые главы моей мудрости, загляни в мой канал 'Дневник повара-садиста': <a href='https://https://t.me/dnevnik_povara_sadista'>@DnevnikPovaraSadista</a>.\n\n" # <-- НОВАЯ СТРОКА
